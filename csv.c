...
void write_summary_header(FILE *f) {
  ...
  WRITEFMT(f, "%s,", "Max RSS p95 (bytes)");
  WRITEFMT(f, "%s,", "Max RSS p99 (bytes)");
  ...
  WRITEFMT(f, "%s,", "Vol Ctx Sw p95 (us)");
  WRITEFMT(f, "%s,", "Vol Ctx Sw p99 (us)");
  ...
  WRITEFMT(f, "%s,", "Invol Ctx Sw p95 (ct)");
  WRITEFMT(f, "%s,", "Invol Ctx Sw p99 (ct)");
  WRITEFMT(f, "%s,", "Total Ctx Sw min (ct)");
  WRITEFMT(f, "%s,", "Total Ctx Sw max (ct)");
  WRITEFMT(f, "%s,", "Total Ctx Sw median (ct)");
  WRITEFMT(f, "%s,", "Total Ctx Sw mode (ct)");
  WRITEFMT(f, "%s,", "Total Ctx Sw p95 (ct)");
  WRITEFMT(f, "%s\n", "Total Ctx Sw p99 (ct)");
  fflush(f);
}
...
void write_summary_line(FILE *f, summary *s) {
  ...
  WRITESEP(f, F_USER, s->user.pct95);
  WRITESEP(f, F_USER, s->user.pct99);
  ...
  WRITESEP(f, F_SYSTEM, s->system.pct95);
  WRITESEP(f, F_SYSTEM, s->system.pct99);
